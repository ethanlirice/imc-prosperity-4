...
Tested `strategies/round5/session/nn-cross-microchip-oval-v12-candidate.py`, a v11 copy
...
Historical NN reference files were incomplete and did not compile, so the local implementation replicated their usable ideas instead of importing them.
