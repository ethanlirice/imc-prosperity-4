...
BASE = ROOT / "strategies/round5/session/nn-cross-mm-ret50-v13-candidate.py"
TRADER = ROOT / "trader.py"
OUT = ROOT / "analysis/round5/neural-signals/47_nn_mm_side_gate_summary.csv"
VARIANT_DIR = ROOT / "analysis/round5/neural-signals/generated-mm-side-sweep"
...
def build_variant(name: str, edit: Callable[[str], str]) -> Path:
    ...
    text = text.replace(
        ...
        f"# NN-directed MM side-gate research variant: {name}.",
    )
