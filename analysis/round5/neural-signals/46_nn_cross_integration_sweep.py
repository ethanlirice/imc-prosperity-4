...
BASE = ROOT / "strategies/round5/session/nn-cross-microchip-oval-v12-candidate.py"
TRADER = ROOT / "trader.py"
OUT = ROOT / "analysis/round5/neural-signals/46_nn_cross_integration_summary.csv"
VARIANT_DIR = ROOT / "analysis/round5/neural-signals/generated-cross-sweep"
...
def build_variant(name: str, specs: List[Dict[str, object]]) -> Path:
    ...
    text = text.replace(
        ...
        f"# NN cross-pressure research variant: {name}.",
    )
