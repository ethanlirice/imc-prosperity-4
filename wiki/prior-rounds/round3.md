# Archived Round 3 Briefing

This file is retained as historical reference only. Active work has moved to
Round 4, with no active `trader.py` baseline and data exploration starting
from scratch. See `wiki/round4.md` for current mechanics.
