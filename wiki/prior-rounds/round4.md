...
Active project state: Round 4 is starting from scratch.
There is no active `trader.py` and no baseline score yet.
Current work should begin with data exploration of `data/ROUND4/`,
especially the newly disclosed `Mark...` counterparty fields.

---

# 
About Data Capsule (in /data/ROUND4): The FTW has identified your trading counterparties as products of several local neuro-robotics research programs. Surprisingly, they are all named “Mark” followed by a number. These IDs have been added to the historical trade data in the Data Capsule. Use this information to re-evaluate your strategy for trading Protein Snackpacks, Velvetfruit Extract, and VEVs.
