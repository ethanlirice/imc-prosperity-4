...
# Primary R5 backtest: prosperity4btx ... 5 --merge-pnl = +581,939
# Days: D2 +161,420 / D3 +203,525 / D4 +216,994
# Experiment: base-strategy.py residual sleeves, but passive MM quotes at touch
# instead of one tick inside on the same selected MM product set.
