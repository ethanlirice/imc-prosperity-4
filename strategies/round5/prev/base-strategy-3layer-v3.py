...
# Rejected/no-promote: quote-skew pair overlay produced no improvement over base-strategy.py.
    ...
    def run(self, state: TradingState):
        ...
        for spec in PAIR_SPECS:
            ...
            if z >= float(spec["entry_z"]):
                pair_bias[a] = pair_bias.get(a, 0) + 1
                pair_bias[b] = pair_bias.get(b, 0) - 1
