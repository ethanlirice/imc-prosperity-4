"""
Round 5 trader v3 — MM + MR on a curated allow-list.

Primary R5 backtest: prosperity4btx ... 5 --merge-pnl = +296,162.

v1 (3 layers) = +79,513.
v2 (drop pairs, MM/MR all 50) = +152,042.
v3 (drop pairs, MM/MR only on 31 net-positive-or-neutral products) = +296,162.

Allow-list comes from v2 per-product PnL. Any product that lost money on
NET across all 3 days is excluded; anything net non-negative is kept.
"""
...
# Allow-list: products with non-negative net PnL across days 2/3/4 in v2.
# Excluded (net loser in v2): PEBBLES_XL/XS/M, PANEL_2X4/1X2/4X4/2X2,
# ROBOT_VACUUMING/MOPPING, TRANSLATOR_SPACE_GRAY/ECLIPSE_CHARCOAL,
# MICROCHIP_SQUARE, GALAXY_SOUNDS_SOLAR_WINDS/BLACK_HOLES, UV_VISOR_RED/YELLOW/AMBER,
# SLEEP_POD_NYLON, OXYGEN_SHAKE_GARLIC.
ALLOWED_PRODUCTS = {
