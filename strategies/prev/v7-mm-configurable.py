...
# Primary R5 backtest: prosperity4btx trader.py 5 --merge-pnl = +1,196,202
# Days: D2 +408,451 / D3 +376,792 / D4 +410,959
# Standalone v7: selected free-alpha path overlay, residual sleeves, direct
# rolling-anchor MR, and owner/side-gated touch MM.
LIMIT = 10
...
MM_PRODUCTS = (MM_PRODUCTS | env_set("ADD_MM_PRODUCTS")) - env_set("DROP_MM_PRODUCTS")
MM_BID_OFF_PRODUCTS = {
    "MICROCHIP_OVAL",
    "MICROCHIP_TRIANGLE",
    "ROBOT_IRONING",
...
MM_BID_OFF_PRODUCTS = (MM_BID_OFF_PRODUCTS | env_set("MM_BID_OFF_PRODUCTS")) - env_set("MM_BID_ON_PRODUCTS")
MM_ASK_OFF_PRODUCTS = (MM_ASK_OFF_PRODUCTS | env_set("MM_ASK_OFF_PRODUCTS")) - env_set("MM_ASK_ON_PRODUCTS")
MM_SIZE = int(os.environ.get("MM_SIZE", "10"))
MM_SIZE_BY_PRODUCT = env_int_map("MM_SIZE_BY_PRODUCT")
