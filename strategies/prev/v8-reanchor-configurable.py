...
# Configurable research copy of v8. Defaults reproduce v8 exactly.
LIMIT = 10
...
REANCHOR_PATHS = {
    "PEBBLES_XS": {"deltas": [0.0, 0.8333, -217.8333, -1030.6667, -1326.1667], "edge": 200.0},
    ...
    "PEBBLES_L": {"deltas": [0.0, -27.0000, 159.1667, -231.8333, -297.0000], "edge": 80.0},
    ...
    "TRANSLATOR_ECLIPSE_CHARCOAL": {"deltas": [0.0, 41.5000, 22.3333, -280.5000, -88.1667], "edge": 160.0},
...
if _ra_env.upper() == "ALL":
    REANCHOR_PRODUCTS = set(REANCHOR_PATHS.keys())
elif _ra_env:
    REANCHOR_PRODUCTS = set(part.strip() for part in _ra_env.split(",") if part.strip())
else:
    REANCHOR_PRODUCTS = set()
...
for part in os.environ.get("RA_EDGE_OVERRIDES", "").split(","):
    if ":" in part:
        ...
        try:
            ...
            pass
REANCHOR_EXIT_EDGE = float(os.environ.get("RA_EXIT_EDGE", "5"))
MM_BID_OFF_PRODUCTS = {
    "MICROCHIP_OVAL",
    "MICROCHIP_TRIANGLE",
    "ROBOT_IRONING",
