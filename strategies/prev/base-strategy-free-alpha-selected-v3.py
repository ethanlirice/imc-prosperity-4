...
# Primary R5 backtest: prosperity4btx ... 5 --merge-pnl = +841,042
# Days: D2 +293,316 / D3 +210,816 / D4 +336,912
# Experiment: v2 plus per-product wider entry thresholds for two products
# whose free-alpha path is stable only at the 200-tick edge.

LIMIT = 10
FREE_ALPHA_ENTRY_EDGE = 80.0
FREE_ALPHA_EXIT_EDGE = 5.0
FREE_ALPHA_ENTRY_EDGE_BY_PRODUCT = {
    "GALAXY_SOUNDS_DARK_MATTER": 200.0,
    "PANEL_2X2": 200.0,
}
