...
ANCHOR_WARMUP = 50  # faster startup on short website slices
V33_EDGE = 4.0
V33_Z_ENTRY = 1.5
...
class Trader:
    ...
    def wall_mid(self, depth):
        ...
        if not bids or not asks:
            return None
        # Proper top-of-book mid: highest bid and lowest ask.
    ...
    def hgp_scaled(self, depth, pos):
        ...
        # Persist a guard when website-like anomalous visible depth appears.
        max_visible = 0
