...
# Use liquid strikes to infer start-of-session days-left from the surface.
...
# Historical per-strike price bias: wall_mid - BS_theo(smile) mean for VEV_5300.
