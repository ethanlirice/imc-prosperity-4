...
# Offline-fitted IV smile in moneyness m = log(K/S)/sqrt(T), from historical days.
SMILE_A = 0.0283
SMILE_B = 0.0025
SMILE_C = 0.2395

# Live Round 3 clock: 5 days to expiry at the start of the session.
START_DAYS_TO_EXPIRY = 5.0
