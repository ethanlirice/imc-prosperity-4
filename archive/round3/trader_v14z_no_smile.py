...
class Trader:
    ...
    def hgp_ntrader(self, depth, pos):
        ...
        if prev_fair is None:
            ...
            fair_value = prev_fair + 0.02 * ((wm if wm is not None else prev_fair) - prev_fair)
    ...
    def smile_sleeve(self, state, out):
        ...
        WARMUP = 50; SPAN = 100; alph = 2.0/(SPAN+1)
    ...
    def run(self, state):
        ...
        # v14z: smile sleeve disabled (only contributes ~70 PnL anyway)
